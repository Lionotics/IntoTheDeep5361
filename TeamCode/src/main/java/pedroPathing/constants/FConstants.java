...
public class FConstants {
    static {
        ...
        FollowerConstants.mass = 13.88;

        FollowerConstants.xMovement = 70.9435;
        FollowerConstants.yMovement = 50.3617;

        FollowerConstants.forwardZeroPowerAcceleration = -25.1766;
        FollowerConstants.lateralZeroPowerAcceleration = -70.1671;
